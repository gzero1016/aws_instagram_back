...
public class SignupReqDto {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9]+@[0-9a-zA-Z]+\\.[a-z]+|[\\d]{11}+$", message = "이메일 또는 전화번호를 입력하세요.")
    private String phoneAndEmail;
    @Pattern(regexp = "^[ㄱ-ㅎ|가-힣]*$", message = "이름은 한글로만 입력해주세요.")
    private String name;
    @Pattern(regexp = "", message = "사용자이름은 공백일 수 없습니다.")
    private String username;
    @Pattern(regexp = "", message = "비밀번호는 공백일 수 없습니다.")
